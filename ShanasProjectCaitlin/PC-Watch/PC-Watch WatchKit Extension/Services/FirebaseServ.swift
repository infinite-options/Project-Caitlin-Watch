...
class FirebaseServ: ObservableObject {
    ...
    func getFirebaseData(completion: @escaping ([Values]) -> ()) {
        guard let url = URL(string: "https://firestore.googleapis.com/v1/projects/project-caitlin-c71a9/databases/(default)/documents/users/GdT7CRXUuDXmteS4rQwN/day_events") else { return }
